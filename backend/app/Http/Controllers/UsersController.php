    ...
    public function updateUserProfile(Request $request)
{
    try {
        ...
        $validatedData = $request->validate([
            ...
            'bio' => 'nullable|string',
            'profile_picture' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // Adjust as needed
        ]);        
        ...
        if ($request->hasFile('profile_picture')) {
            ...
            $user->update(['profile_picture' => 'http://' . $storagePath . '/storage/user-profiles/' . $imageName]);
        }
