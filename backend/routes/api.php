...
use App\Http\Controllers\ClassRuleController;
...
Route::put('/change-company', [SchoolClassController::class, 'assignCompanyToStudent']);
...
Route::post('/class-rule', [ClassRuleController::class, 'store']);
Route::post('/class-rules/update', [ClassRuleController::class, 'update']);
Route::get('/class-rules/index', [ClassRuleController::class, 'index']);
Route::post('/class-rules/check-and-update', [ClassRuleController::class, 'checkAndUpdate']);
